                            ...
                            <div className="animate-in fade-in duration-500 space-y-8 pb-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    {highlightedProducts.map((p) => (
                                        <Card key={p.id} className="border-none shadow-xl shadow-slate-100 bg-white border border-slate-100 overflow-hidden rounded-[32px] hover:border-orange-200 transition-all h-full flex flex-col group">
                                            <CardHeader className="flex-1">
                                                ...
                                                <CardTitle className="text-lg font-black text-slate-900 uppercase italic mb-1">{p.name}</CardTitle>
                                                <p className="text-[10px] font-bold text-slate-500 italic">{p.company_name}</p>
                                                <p className="text-[9px] font-bold text-slate-400 italic mt-1">Ganha +{p.points_reward} PTS</p>
                                            </CardHeader>
