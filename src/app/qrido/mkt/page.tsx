...
import { Megaphone, Save, CheckCircle2, MessageCircle } from 'lucide-react'
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8 py-10">
            <div className="flex flex-col gap-4">
                <BackButton />
                <div>
                    <h1 className="text-4xl font-black tracking-tight text-slate-900 italic">MKT (MARKETING)</h1>
                    <p className="text-slate-500 mt-1">Gerencie suas ferramentas de engajamento e destaque.</p>
                </div>
            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    className="w-full pl-12 pr-4 py-3 min-h-[100px] rounded-2xl border border-slate-100 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue bg-white text-sm outline-none transition-all shadow-sm font-medium"
